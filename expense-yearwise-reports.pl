...
# Obtener los datos de gastos por año
my $sth_expenses = $dbh->prepare("
    SELECT YEAR(ExpenseDate) AS ExpenseYear, SUM(ExpenseCost) AS TotalExpense
    FROM tblexpense
    WHERE UserId = ?
...
while (my $expense = $sth_expenses->fetchrow_hashref) {
    push @years, $expense->{ExpenseYear};
    push @expenses, $expense->{TotalExpense};
}

# Convertir los arrays a cadenas JSON
use JSON;
my $years_json = encode_json(\@years);
my $expenses_json = encode_json(\@expenses);
...
<head>
    ...
    <title>Daily Expense Tracker || Reporte de Gastos Anuales</title>
        ...
        <ul class="nav menu">
            ...
            <li class="parent active"><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse in" id="sub-item-2">
                    ...
                    <li class="active"><a class="" href="/cgi-bin/dets/expense-yearwise-reports.pl">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Reportes de Gastos Anuales</li>
            </ol>
        </div><!--/.row-->
        
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Reportes de Gastos Anuales</h1>
            </div>
        </div><!--/.row-->
